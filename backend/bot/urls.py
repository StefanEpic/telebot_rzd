...
from bot.views import (
    InstructionsViewset,
    KsotpViewset,
    KnowledgeTestSchedulesViewset,
    KnowledgeTestFormsViewset,
    MagazineDesignExamplesViewset,
    SokViewset,
    ApplicationFormsViewset,
    TechnicalStudiesViewset,
    RemindersViewset,
    NormativeDocumentsViewset,
    FireSafetyViewset,
)
...
router.register(
    r"knowledge_test_schedules",
    KnowledgeTestSchedulesViewset,
    basename="knowledge_test_schedules",
)
router.register(
    r"knowledge_test_forms",
    KnowledgeTestFormsViewset,
    basename="knowledge_test_forms",
)
router.register(
    r"magazine_design_examples",
    MagazineDesignExamplesViewset,
    basename="magazine_design_examples",
)
...
router.register(
    r"normative_documents",
    NormativeDocumentsViewset,
    basename="normative_documents",
)
