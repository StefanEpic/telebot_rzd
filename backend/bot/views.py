...
from bot.serializers import (
    ...
    KsotpSerializer,
    KnowledgeTestSchedulesSerializer,
    KnowledgeTestFormsSerializer,
    MagazineDesignExamplesSerializer,
    SokSerializer,
    ApplicationFormsSerializer,
    TechnicalStudiesSerializer,
    RemindersSerializer,
    NormativeDocumentsSerializer,
    FireSafetySerializer,
)
